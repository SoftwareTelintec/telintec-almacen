...
# side bar panel to navigate through the application
sidebar_frame = CTkFrame(master=app, fg_color="#04053A",
                         width=250, height=650, corner_radius=0)
sidebar_frame.pack_propagate(0)
sidebar_frame.pack(fill="y", anchor="w", side="left")

# logo icon
logo_img_data = Image.open("./assets/logo.webp")
logo_img = CTkImage(dark_image=logo_img_data,
                    light_image=logo_img_data, size=(120, 75))
...
CTkButton(master=sidebar_frame,
          image=analytics_img,
          text="Dashboard",
...
CTkButton(master=title_frame, text="+ New Order",  font=("Arial Black", 15), text_color="#fff",
          fg_color="#04053A", hover_color="#07096b").pack(anchor="ne", side="right")
...
logitics_img_data = Image.open("./assets/logistics_icon.png")
...
shipping_img_data = Image.open("./assets/shipping_icon.png")
...
delivered_metric = CTkFrame(
    master=metrics_frame, fg_color="#04053A", width=200, height=60)
delivered_metric.grid_propagate(0)
delivered_metric.pack(side="right",)

delivered_img_data = Image.open("./assets/delivered_icon.png")
...
CTkEntry(master=search_container, width=305, placeholder_text="Search Order",
         border_color="#04053A", border_width=2).pack(side="left", padx=(13, 0), pady=15)

CTkComboBox(master=search_container, width=125, values=["Date", "Most Recent Order", "Least Recent Order"], button_color="#04053A", border_color="#04053A", border_width=2,
            button_hover_color="#07096b", dropdown_hover_color="#07096b", dropdown_fg_color="#04053A", dropdown_text_color="#fff").pack(side="left", padx=(13, 0), pady=15)
CTkComboBox(master=search_container, width=125, values=["Status", "Processing", "Confirmed", "Packing", "Shipping", "Delivered", "Cancelled"], button_color="#04053A", border_color="#04053A",
            border_width=2, button_hover_color="#07096b", dropdown_hover_color="#07096b", dropdown_fg_color="#04053A", dropdown_text_color="#fff").pack(side="left", padx=(13, 0), pady=15)
...
table = CTkTable(master=table_frame, values=table_data, colors=[
                 "#E6E6E6", "#EEEEEE"], header_color="#04053A", hover_color="#B4B4B4")
